            ...
            @forelse ($table as $key => $tb)
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge badge-warning">perlu diproses</span>
                    ...
                    <td>
                        <a href="/admin/mutasi/show/{{ $tb->id }}" class="btn btn-sm btn-info">lihat</a>
                        @if ($tb->status == 'diterima')
                        <a href="{{ route('surat_izin', ['folder'=> 'mutasi', 'filename' => $tb->suratizin]) }}" target="_blank" class="btn btn-sm btn-primary">Unduh surat balasan</a>
                        @endif
                    </td>
                </tr>
            @empty
