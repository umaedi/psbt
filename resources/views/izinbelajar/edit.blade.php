                ...
                <form action="/user/permohonan_izin_belajar/update/{{ $izin_belajar->id }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="form-group">
                      ...
                      <a href="{{ route('lampiran', ['folder' => 'izin_belajar', 'year' => $izin_belajar->created_at->format('Y'), 'filename' => $izin_belajar->lampiran1]) }}" target="_blank">Lihat lampiran sebelumnya</a>
                      @error('lampiran1')
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{ route('lampiran', ['folder' => 'izin_belajar', 'year' => $izin_belajar->created_at->format('Y'), 'filename' => $izin_belajar->lampiran2]) }}" target="_blank">Lihat lampiran sebelumnya</a>
                      @error('lampiran2')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      <a href="{{ route('lampiran', ['folder' => 'izin_belajar', 'year' => $izin_belajar->created_at->format('Y'), 'filename' => $izin_belajar->lampiran3]) }}" target="_blank">Lihat lampiran sebelumnya</a>
                      @error('lampiran3')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      <a href="{{ route('lampiran', ['folder' => 'izin_belajar', 'year' => $izin_belajar->created_at->format('Y'), 'filename' => $izin_belajar->lampiran4]) }}" target="_blank">Lihat lampiran sebelumnya</a>
                      @error('lampiran4')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    @include('layouts._loading')
                    <button id="btnSubmit" type="submit" class="btn btn-primary">PERBAHARUI PERMOHONAN</button>
                </form>
            </div>
            </div>
          </div>
